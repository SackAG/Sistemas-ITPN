...
class UpdateAulaRequest extends FormRequest
{
    ...
    /**
     * Reglas de validación para actualizar un aula.
     * 
     * @return array<string, \Illuminate\Contracts\Validation\ValidationRule|array<mixed>|string>
     */
    public function rules(): array
    {
        // Obtener el ID del aula desde el parámetro de ruta
        $aulaId = $this->aula instanceof Aula ? $this->aula->id : $this->aula;
        ...
        return [
            'nombre' => [
                ...
                'string',
                'max:100',
                // Ignorar el nombre del aula actual al validar unicidad
