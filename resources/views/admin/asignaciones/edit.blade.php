...
@section('title', 'Editar Asignación de Aula')
            ...
            <div class="col-12">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <p class="text-muted mb-0">Modifica los datos de la asignación</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-10">
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="card-body p-4">
                        <form action="{{ route('admin.asignaciones.update', $asignacione->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="aula_id" id="aula_id" class="form-select @error('aula_id') is-invalid @enderror" required>
                                        ...
                                        @foreach($aulas as $aula)
                                            <option value="{{ $aula->id }}" {{ (old('aula_id', $asignacione->aula_id) == $aula->id) ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="grupo_id" id="grupo_id" class="form-select @error('grupo_id') is-invalid @enderror" required>
                                        ...
                                        @foreach($grupos as $grupo)
                                            <option value="{{ $grupo->id }}" {{ (old('grupo_id', $asignacione->grupo_id) == $grupo->id) ? 'selected' : '' }}>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="dia_semana" id="dia_semana" class="form-select @error('dia_semana') is-invalid @enderror" required>
                                        ...
                                        @foreach($diasSemana as $dia)
                                            <option value="{{ $dia }}" {{ (old('dia_semana', $asignacione->dia_semana) == $dia) ? 'selected' : '' }}>
                                                {{ $dia }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="time" 
                                           ...
                                           value="{{ old('hora_inicio', substr($asignacione->hora_inicio, 0, 5)) }}"
                                           required>
                                    @error('hora_inicio')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="time" 
                                           ...
                                           value="{{ old('hora_fin', substr($asignacione->hora_fin, 0, 5)) }}"
                                           required>
                                    @error('hora_fin')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="date" 
                                           ...
                                           value="{{ old('fecha_inicio_vigencia', $asignacione->fecha_inicio_vigencia?->format('Y-m-d')) }}"
                                           required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="date" 
                                           ...
                                           value="{{ old('fecha_fin_vigencia', $asignacione->fecha_fin_vigencia?->format('Y-m-d')) }}"
                                           required>
                                ...
                                <div class="col-12">
                                    <div class="form-check form-switch">
                                        <input type="checkbox" 
                                               ...
                                               value="1" 
                                               {{ old('activo', $asignacione->activo) ? 'checked' : '' }}>
                                    ...
                                    <small class="text-muted">
                                        Desactiva esta opción si la asignación ya no está vigente
                                    </small>
                                </div>
                            </div>
