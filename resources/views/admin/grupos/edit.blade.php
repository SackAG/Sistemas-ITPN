        ...
        <div class="row mb-4">
            <div class="col-12">
                ...
                <h2 class="mb-1">
                    ...
                    Editar Grupo: {{ $grupo->clave_grupo }}
                </h2>
                    ...
                    <div class="alert alert-info mb-4" role="alert">
                        ...
                        @if($alumnosCount > 0)
                            <p class="mb-0 mt-2 small">
                                ...
                                Este grupo tiene alumnos inscritos, no puede ser eliminado.
                            </p>
                        @endif
                    </div>
                @endif
                        ...
                        <form action="{{ route('admin.grupos.update', $grupo) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('clave_grupo', $grupo->clave_grupo) }}"
                                       maxlength="50"
                                       required>
                                @error('clave_grupo')
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select @error('periodo') is-invalid @enderror" 
                                        ...
                                        <option value="Ene-Abr" 
                                                {{ (old('periodo') ?? $grupo->periodo) == 'Ene-Abr' ? 'selected' : '' }}>
                                            Ene-Abr
                                        </option>
                                        <option value="May-Ago" 
                                                {{ (old('periodo') ?? $grupo->periodo) == 'May-Ago' ? 'selected' : '' }}>
                                            May-Ago
                                        </option>
                                        <option value="Sep-Dic" 
                                                {{ (old('periodo') ?? $grupo->periodo) == 'Sep-Dic' ? 'selected' : '' }}>
                                            Sep-Dic
                                        </option>
                                    </select>
                                    @error('periodo')
                            ...
                            <div class="mb-4">
                                <div class="form-check form-switch">
                                    ...
                                    <input class="form-check-input @error('activo') is-invalid @enderror" 
                                           ...
                                           name="activo"
                                           value="1"
                                           {{ old('activo', $grupo->activo) == '1' ? 'checked' : '' }}>
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const profesorActual = {{ $grupo->profesor_id ?? 'null' }};
            ...
            function filtrarProfesores() {
                ...
                profesoresFiltrados.forEach(profesor => {
                    ...
                    if (profesorActual && profesor.id == profesorActual) {
            ...
            // Ejecutar el filtrado al cargar la página para mostrar solo los profesores válidos
            filtrarProfesores();
        });
    </script>
@endpush
